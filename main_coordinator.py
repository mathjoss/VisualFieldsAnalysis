...
for ID in IDList :
    ...
    trialFrames, frame_number = step2.check_errors(cap, trialFrames, txtFile, orientation, thresh, movfix, asym)

    camarche=7
    
    ######## STEP 4 : compute location
    if orientation == 'lr' :
        trialFrames, final4 = step3.find_location_lr(trialFrames, txtFile, area1, area2, area3, area4, area5, numbframes)
    elif orientation =='bt' :
        trialFrames, final4 = step3.find_location_bt(trialFrames, txtFile, area1, area2, area3, area4, area5, numbframes)
