...
def create_visual_fields(txtFile, final4, frontalangle, lateralangle, cap, numbframes, asym, problem, resp_gofast) :    
    ...
    # paste stimulus like the moving condition, in order not to change the code :)
    if asym== False:
        final4['stimx'] = int(txtFile.stimx)
        final4['stimy'] = int(txtFile.stimy)
    elif asym== True:
        final4['stim1x'] = int(txtFile.stim1x)
        final4['stim1y'] = int(txtFile.stim1y)
        final4['stim2x'] = int(txtFile.stim2x)
        final4['stim2y'] = int(txtFile.stim2y)
    ...
    if resp_gofast == "n":
        ...
        if response == 'y':
            ...
            for picnum in randompic :
                ...
                cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic, final4.columns.get_loc("topheadx")]), int(final4.iloc[indexpic, final4.columns.get_loc("topheady")])),(0, 255, 0),2)
                cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic, final4.columns.get_loc("frontalRX")]), int(final4.iloc[indexpic, final4.columns.get_loc("frontalRY")])),(0, 255, 0),2)
                cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic, final4.columns.get_loc("frontalLX")]), int(final4.iloc[indexpic, final4.columns.get_loc("frontalLY")])),(0, 255, 0),2)
    ...
    if asym == False:
        final4 = final4.drop(['stimx', 'stimy'], axis=1)
    elif asym == True:
        final4 = final4.drop(['stim1x', 'stim1y', 'stim2x', 'stim2y'], axis=1)
