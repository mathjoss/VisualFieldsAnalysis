    ...
    if resp_gofast == "n":
        ...
        if response == 'y':
            ...
            # check whether stimulus in on the top or bottom if asym=False
                if asym==False:
                    if abs(txtFile.topborder[0] - final4['stimy'].mean()) < abs(txtFile.bottomborder[0] - final4['stimy'].mean()):             
                        side="top"
                    else:
                        side="bottom"
                else:
                ...
                if side == "top" and asym==False:
                    ...
                    if math.isnan(final4.iloc[indexpic, index_angletop_col])==False:
                    ...
                    if math.isnan(final4.iloc[indexpic, index_anglebot_col])==False:
                ...
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc('betweeneyesX')])==False:
                    if asym==False :
                        ...
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic,final4.columns.get_loc("stimtopx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimtopy")])),(150, 150, 150),1)
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic,final4.columns.get_loc("stimbottomx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimbottomy")])),(150, 150, 150),1)
                ...
                if asym == False:
                    ...
                    if math.isnan(final4.iloc[indexpic,final4.columns.get_loc("stimtopy")])== False:
                        cv2.circle(frame, (int(final4.iloc[indexpic,final4.columns.get_loc("stimtopx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimtopy")])), 3, (68, 1, 84), -1)
                    if math.isnan(final4.iloc[indexpic,final4.columns.get_loc("stimbottomy")])== False:
                        cv2.circle(frame, (int(final4.iloc[indexpic,final4.columns.get_loc("stimbottomx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimbottomy")])), 3, (68, 1, 84), -1)
