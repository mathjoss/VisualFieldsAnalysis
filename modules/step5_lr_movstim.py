    ...
    if resp_gofast == "n":
        ...
        if response == 'y':
            ...
            for picnum in randompic :
                ...
                if asym == False:
                    if abs(txtFile.leftborder[0] - final4['stimx'].mean()) < abs(txtFile.rightborder[0] - final4['stimx'].mean()):             
                        side="left"
                    else:
                        side="right"
                elif asym == True:
                ...
                if side == "left" and asym==False:
                    ...
                    if math.isnan(final4.iloc[indexpic, index_angle_col])==False:
                    ...
                    if math.isnan(final4.iloc[indexpic, index_angleleft_col])==False:
                    ...
                    if math.isnan(final4.iloc[indexpic, index_angleright_col])==False:
                ...
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc('betweeneyesX')])==False:
                    if asym==False:
                        ...
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic,final4.columns.get_loc("stimleftx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimlefty")])),(150, 150, 150),1)
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(final4.iloc[indexpic,final4.columns.get_loc("stimrightx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimrighty")])),(150, 150, 150),1)
                ...
                if asym == False:
                    ...
                    if math.isnan(final4.iloc[indexpic,final4.columns.get_loc("stimlefty")])== False:
                        cv2.circle(frame, (int(final4.iloc[indexpic,final4.columns.get_loc("stimleftx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimlefty")])), 3, (68, 1, 84), -1)
                    if math.isnan(final4.iloc[indexpic,final4.columns.get_loc("stimrighty")])== False:
                        cv2.circle(frame, (int(final4.iloc[indexpic,final4.columns.get_loc("stimrightx")]), int(final4.iloc[indexpic,final4.columns.get_loc("stimrighty")])), 3, (68, 1, 84), -1)
