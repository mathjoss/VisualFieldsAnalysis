    ...
    if resp_gofast=="n":
        ...
        if response == 'y':
            ...
            for picnum in randompic :
                ...
                if side == "left" or asym==True:
                    cv2.rectangle(frame, (int(txtFile.leftborder[0] + lengthArena/10 - 10), 120), (int(txtFile.leftborder[0] + lengthArena/10 + 210), 280), (0,0,0), -1)
                if side =="right" or asym==True:
                    cv2.rectangle(frame, (int(txtFile.leftborder[0] + 7*lengthArena/10 - 10), 120), (int(txtFile.leftborder[0] + 7*lengthArena/10 + 210), 280), (0,0,0), -1)
                ...
                if side == "left" and asym==False:
                    index_angle_col = final4.columns.get_loc("angle")
                    textprint.append(final4.columns[index_angle_col] + ' ' + str(round(final4.iloc[indexpic, index_angle_col],0))+ ' deg')
                ...
                elif side == "right" and asym==False:
                    index_angle_col = final4.columns.get_loc("angle")                    
                    textprint2.append(final4.columns[index_angle_col] + ' ' + str(round(final4.iloc[indexpic, index_angle_col],0))+ ' deg')
                    ...
                    index_angleleft_col = final4.columns.get_loc("angle_stimleft")
                    textprint.append(final4.columns[index_angleleft_col] + ' ' + str(round(final4.iloc[indexpic, index_angleleft_col],0))+ ' deg')
                    for i in range(0,len(textprint)):
                        starttextpoint1 = txtFile.leftborder[0] + lengthArena/10
                        cv2.putText(frame, textprint[i], (int(starttextpoint1),150+i*30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (250,250,250),1)
                    index_angleright_col = final4.columns.get_loc("angle_stimright")                    
                    textprint2.append(final4.columns[index_angleright_col] + ' ' + str(round(final4.iloc[indexpic, index_angleright_col],0))+ ' deg')
                    for i in range(0,len(textprint2)): 
                        starttextpoint2 = txtFile.leftborder[0] + 7*lengthArena/10
                        cv2.putText(frame, textprint2[i], (int(starttextpoint2),150+i*30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (250,250,250),1)
                
                # write picture index number
                ...
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalRleft")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.leftborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalRleft")])),(255,0,0),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalRright")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.rightborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalRright")])),(255,0,0),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalLleft")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.leftborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalLleft")])),(255,0,0),2)        
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalLright")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.rightborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptfrontalLright")])),(255,0,0),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptblindRleft")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.leftborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptblindRleft")])),(0, 255, 255),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptblindRright")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.rightborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptblindRright")])),(0, 255, 255),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptblindLleft")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.leftborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptblindLleft")])),(0, 255, 255),2)
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc("interceptblindLright")])== False:
                    cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.rightborder[0]), int(final4.iloc[indexpic, final4.columns.get_loc("interceptblindLright")])),(0, 255, 255),2)
                ...
                if math.isnan(final4.iloc[indexpic, final4.columns.get_loc('betweeneyesX')])==False:
                    if side == "left" and asym==False:
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(center_stim_x), int(center_stim_y)),(150, 150, 150),1)
                    elif side == "right" and asym==False:
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(center_stim_x), int(center_stim_y)),(150, 150, 150),1)
                    elif asym == True:
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.leftborder[0]), int(center_stim_y_left)),(150, 150, 150),1)
                        cv2.line(frame,(int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesX")]), int(final4.iloc[indexpic, final4.columns.get_loc("betweeneyesY")])),(int(txtFile.rightborder[0]), int(center_stim_y_right)),(150, 150, 150),1)
               
                # print stimuli borders
                if side=="left" and asym == False:
                    cv2.circle(frame, (int(txtFile.leftborder[0]), int(txtFile.topstimy[0])), 3, (68, 1, 84), -1)
                    cv2.circle(frame, (int(txtFile.leftborder[0]), int(txtFile.bottomstimy[0])), 3, (68, 1, 84), -1)
                    cv2.line(frame,( int(txtFile.leftborder[0]), int(txtFile.topstimy[0])),(int(txtFile.leftborder[0]), int(txtFile.bottomstimy[0])), (68, 1, 84),2)
                elif side=="right" and asym==False:
                    cv2.circle(frame, (int(txtFile.rightborder[0]), int(txtFile.topstimy[0])), 3, (68, 1, 84), -1)
                    cv2.circle(frame, (int(txtFile.rightborder[0]), int(txtFile.bottomstimy[0])), 3, (68, 1, 84), -1) 
                    cv2.line(frame,( int(txtFile.rightborder[0]), int(txtFile.topstimy[0])),(int(txtFile.rightborder[0]), int(txtFile.bottomstimy[0])), (68, 1, 84),2)
                
                elif asym==True:
                    cv2.circle(frame, (int(txtFile.leftborder[0]), int(txtFile.topleftstimy[0])), 3, (68, 1, 84), -1)
                    cv2.circle(frame, (int(txtFile.leftborder[0]), int(txtFile.bottomleftstimy[0])), 3, (68, 1, 84), -1)
                    cv2.line(frame,( int(txtFile.leftborder[0]), int(txtFile.topleftstimy[0])),(int(txtFile.leftborder[0]), int(txtFile.bottomleftstimy[0])), (68, 1, 84),2)
                    cv2.circle(frame, (int(txtFile.rightborder[0]), int(txtFile.toprightstimy[0])), 3, (68, 1, 84), -1)
                    cv2.circle(frame, (int(txtFile.rightborder[0]), int(txtFile.bottomrightstimy[0])), 3, (68, 1, 84), -1) 
                    cv2.line(frame,( int(txtFile.rightborder[0]), int(txtFile.toprightstimy[0])),(int(txtFile.rightborder[0]), int(txtFile.bottomrightstimy[0])), (68, 1, 84),2)
